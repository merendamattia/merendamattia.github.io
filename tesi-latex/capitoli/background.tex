...
funzione di transizione è definita come segue: $Y(S,T)=S'$, dove $S$ è il vecchio stato macchina valido e $T$ è un insieme di transazioni valide che, 
...
dell’esecuzione del codice di tali contratti. Gli sviluppatori possono scrivere gli smart contract utilizzando diversi linguaggi di alto livello, come Solidity
\footnote{\url{https://docs.soliditylang.org/en/latest/}} o Vyper\footnote{\url{ https://docs.vyperlang.org/en/stable/toctree.html}}, ma affinché possano essere 
...
messo in cima allo stack. Allo stesso modo, i byte {\tt 60 02} rappresentano l’istruzione EVM {\tt PUSH1 0x02} (lo stack dopo l’esecuzione di questi opcode è mostrato 
in Fig. ~\ref{fig:stack-a}). L’ultimo byte, ossia {\tt 01}, corrisponde all’opcode {\tt ADD}, il quale preleva due elementi dallo stack, li somma e mette il risultato di nuovo 
...
Dopo l’esecuzione di queste istruzioni, l’elemento in cima allo stack avrà il valore 3 (lo stack dopo l’operazione {\tt ADD} è mostrato nella Figura \ref{fig:stack-b}).
